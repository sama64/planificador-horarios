...
{#if $selectionComplete}
  ...
  <div class="divider my-8">Sobre preferencias</div>

  <div class="card bg-base-100 shadow-xl">
    <div class="card-body">
      <h2 class="card-title">Sobre preferencias</h2>
      ...
      <div class="alert alert-warning mt-4">
        ...
        <span><span class="font-bold">Importante:</span> Si el sistema no puede encontrar un horario que cumpla con sus preferencias, las ignorará automáticamente para asegurar que todas las asignaturas puedan ser programadas.</span>
      </div>
    </div>
  </div>
{/if}
